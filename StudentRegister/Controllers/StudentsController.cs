...
namespace StudentRegister.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dob,Email,Gender,Status,Course")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dob,Email,Gender,Status,Course")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
